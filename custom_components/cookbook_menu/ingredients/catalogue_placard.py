...
PRODUITS_PLACARD: tuple[str, ...] = (
    ...
    "Fenouil en graines", "Graines de fenouil", "Graines de moutarde", "Safran", "Quatre-épices",
    "Cinq-épices", "Ras el hanout", "Garam masala", "Colombo", "Tandoori", "Épices à couscous",
    "Épices à tajine", "Épices cajun", "Zaatar", "Sumac", "Mélange cinq baies", "Vanille",
    "Gousse de vanille", "Extrait de vanille", "Arôme vanille", "Sucre vanillé", "Réglisse", "Genièvre",
    "Baies de genièvre",
    "Ail en poudre", "Oignon en poudre", "Échalote séchée", "Oignons frits",
    # Herbes sèches
    ...
    "Coulis de tomate", "Purée de tomate", "Passata", "Sauce tomate", "Tomates pelées",
    "Dés de tomates en conserve", "Tomates concassées", "Tomates séchées", "Miso", "Mirin", "Saké",
    "Vin blanc de cuisine", "Cognac", "Rhum", "Kirsch", "Porto", "Amaretto",
    # Bouillons et fonds
    ...
    "Nouilles chinoises", "Nouilles de riz", "Vermicelles de riz", "Ramen", "Riz", "Riz basmati",
    "Riz thaï", "Riz rond", "Riz arborio", "Riz carnaroli", "Riz complet", "Riz sauvage", "Semoule",
    "Couscous", "Boulgour", "Quinoa", "Polenta", "Sarrasin", "Épeautre", "Orge perlé", "Flocons d'avoine",
    "Avoine", "Tapioca", "Chapelure", "Panko", "Croûtons", "Biscottes", "Gressins", "Crackers",
    "Pain azyme", "Tortillas", "Galettes de riz",
    # Légumineuses sèches ou en conserve
    "Lentilles", "Lentilles vertes", "Lentilles corail", "Lentilles blondes", "Pois chiches",
    "Pois cassés", "Haricots rouges", "Haricots blancs", "Haricots noirs", "Flageolets", "Fèves sèches",
    # Farines, sucres, pâtisserie
    "Farine", "Farine de blé", "Farine complète", "Farine de riz", "Farine de maïs", "Maïzena",
    "Fécule", "Fécule de maïs", "Fécule de pomme de terre", "Farine de sarrasin", "Farine de pois chiche",
    ...
    "Vergeoise", "Sucre de canne", "Sucre complet", "Miel", "Sirop d'érable", "Sirop d'agave", "Mélasse",
    "Chocolat noir", "Chocolat pâtissier", "Chocolat à cuire", "Chocolat au lait", "Chocolat blanc",
    "Pépites de chocolat", "Cacao", "Poudre de cacao", "Café", "Café soluble", "Thé", "Tisane", "Infusion",
    "Poudre d'amande", "Amandes en poudre", "Poudre de noisette", "Noix de coco râpée", "Pralin",
    "Pralinoise", "Pâte à tartiner", "Confiture", "Sirop de grenadine", "Grenadine", "Colorant alimentaire",
    "Vermicelles au chocolat", "Perles de sucre", "Boudoirs", "Biscuits", "Crêpes dentelle",
...
def est_produit_de_placard(cle_produit: str) -> bool:
    """Vrai si le produit est un ingrédient de placard connu (ou une variante : « riz basmati bio »)."""
    if not cle_produit:
        return False
    cles = _cles()
    ...
    return any(" ".join(mots[:n]) in cles for n in range(len(mots) - 1, 0, -1))
